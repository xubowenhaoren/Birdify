...
file_name = "efficient_net_no_cv_dropout_log.txt"
...
if __name__ == '__main__':
    ...
    plot_helper(data_arr, max_epoch, "EfficientNet with dropout p=0.5: Accuracy", "Accuracy")

    data_arr = [(train_loss_logs, "-o", "train"), (validation_loss_logs, "--o", "validation")]
    plot_helper(data_arr, max_epoch, "EfficientNet with dropout p=0.5: Loss", "Loss")
